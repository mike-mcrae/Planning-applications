...
SCRIPTS_DIR = BASE_DIR / "1. scripts"

PLANNING_CSV = DATA_DIR / "IrishPlanningApplications_DublinCityCouncil.csv"
GEOCODED_CSV = DATA_DIR / "DCC_all_applications_geocoded.csv"
MASTER_OBS_CSV = SCRIPTS_DIR / "outputs" / "applications_master_with_obs.csv"
SA_SHP = (
    DATA_DIR
    / "Small_Area_National_Statistical_Boundaries_2022_Ungeneralised_view_2205995009404967982"
    / "SMALL_AREA_2022.shp"
)
SA_POP_JSON = DATA_DIR / "cso" / "SAP2022T1T1ASA.20260219T220214.json"
ED_POP_CSV = DATA_DIR / "cso" / "CensusHub2022_T9_1_ED_7008835473864658512.csv"
